...
/**
 * Users Admin - Category Plugin  Filter - Library Plugin Implementation
 *
 * @package         local
 * @subpackage      myusers/filter
...
class myusers_filtering {
     ...
     */
    function myusers_filtering($fieldnames=null, $baseurl=null, $extraparams=null) {
        global $SESSION;
    ...
    function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'cohort':          return new user_filter_text('cohort', get_string('idnumber', 'core_cohort'), $advanced, 'cohort'); //return new user_filter_cohort($advanced);
...
class myusers_filter_type {
     ...
     */
    function myusers_filter_type($name, $label, $advanced) {
        $this->_name     = $name;
        $this->_label    = $label;
