...
$string['metaprefix'] = 'Meta-tagg prefiks';
$string['metaprefix_desc'] = 'Angi prefikset som brukes for alle metatagger, slik som "Meta_"';
$string['metagroupprefix'] = 'Tagg-prefiks for metagrupper';
$string['metagroupprefix_desc'] = 'Angi prefiks som skal brukes for alle metagruppe-tagger, som "Meta_gruppe"';
$string['metaoptionprefix'] = 'Tagg-prefiks for Meta-opsjon';
...
$string['editgrouptags_taggroups'] = 'Tagg-grupper';
$string['editgrouptags_tagnogroups'] = 'Tagger uten gruppe';
$string['editgrouptags_filterlist'] = 'Filtrer tagglista';
$string['editgrouptags_notagsinlist'] = 'Ingen tagger sendt.';
$string['editgrouptags_menuentry'] = 'Rediger metagruppe-tagger';
