<?php
/**
 * KS Læring Integration - Language Strings (Norwegian)
 *
 * @package         local
 * @subpackage      wsks/lang
...
$string['pluginname']   = 'KS Læring-integrasjon';
...
$string['slave_settings']   = 'Slave-tjeneste integrasjon';
