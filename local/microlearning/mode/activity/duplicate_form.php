...
class duplicate_activity_form extends moodleform {
    function definition() {
        /* Parameters   */
        ...
        /* Type Campaigns       */
        $form->addElement('radio','type','',get_string('activity_mode','local_microlearning'),ACTIVITY_MODE);
