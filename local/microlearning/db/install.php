...
function xmldb_local_microlearning_install() {
    ...
    $tbl_micro_calendar = Get_MicrolearningCalendar_Table();
    ...
    $tbl_micro_activity = Get_MicroLearningActivity_Table();
    ...
    $tbl_micro_users = Get_MicrolearningUsers_Table();
    ...
    $tbl_micro_deliveries = Get_MicrolearningDeliveries_Table();
 ...
 */
function Get_MicroLearning_Table() {
    /* Variables    */
 ...
 */
function Get_MicrolearnigActivities_Table() {
    /* Variables    */
 ...
 */
function Get_MicrolearningCalendar_Table() {
    /* Variables    */
 ...
 */
function Get_MicroLearningActivity_Table() {
    /* Variables    */
 ...
 */
function Get_MicrolearningUsers_Table() {
    /* Variables        */
 ...
 */
function Get_MicrolearningDeliveries_Table() {
    /* Variables        */
