...
class local_friadmin_helper {
    ...
    protected static function restore_course($cid, $options, $withusers = 1, $forcebackup = false) {
        ...
        try {
             ...
             *
             * Description
             * Restore the course with the correct name
             */
            $courseid = restore_dbops::create_new_course(fix_utf8($options['fullname']),
                fix_utf8($options['shortname']), $options['categoryid']);
