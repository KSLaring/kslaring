...
M.core_user.init_data_report = function (Y, parent, category, course) {
    var data_rpt = {
        querydelay: 0.5,
        ...
        send_query_cat : function(toclean) {
            ...
            var iotrans = Y.io(M.cfg.wwwroot + '/local/friadmin/reports/category.php',
                {
                    method: 'POST',
                    data: 'parent=' + parent + '&sesskey=' + M.cfg.sesskey,
                    on: {
