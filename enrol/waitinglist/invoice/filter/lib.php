...
class waitinglist_filtering {
     ...
     */
    function waitinglist_filtering($fieldnames=null, $baseurl=null, $extraparams=null) {
        global $SESSION;
        ...
        // now the active filters
    }//constructor_waitinglist_filtering
...
}//waitinglist_filtering

class waitinglist_filter_type {
    /**
