...
/**
 * Capabilities for waitinglist enrolment plugin.
 *
...
$capabilities = array(
    ...
    /* Add, edit or remove waitinglist enrol instance. */
    'enrol/waitinglist:config' => array(
        'captype' => 'write',
...
*/
    ...
    'enrol/waitinglist:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
