<?php
/**
 * Report Generator - Company Report  Filter - Library Plugin Implementation
 *
 * @package         report
 * @subpackage      generator/company_report/filter
...
class company_report_filtering {
    ...
    function get_sql_filter($extra='', array $params=null) {
        ...
        $my_company = report_generator_getCompanyUser($USER->id);
