 ...
 *
 * @package     report
 * @subpackage  generator/employee_report
 ...
 */
function report_generator_EmployeeReport_getOutcomes($job_role=null) {
    global $DB;
...
}//report_generator_EmployeeReport_getOutcomes
 ...
 */
function report_generator_EmployeeReport_getInfo($company_id,$outcome) {
    global $DB;
    ...
    try {
        /* Outcome Info */
        $out_info = report_generator_EmployeeReport_getOutcomeInfo($outcome);
        ...
        /* Users Info   */
        $employee_rpt->users        = report_generator_EmployeeReport_getOutcomeUsersInfo($out_info->courses_id,$out_info->jobroles,$company_id);

        return $employee_rpt;
    }catch(Exception $ex) {
        throw $ex;
    }//try_catch
}//report_generator_EmployeeReport_getInfo
 ...
 */
function report_generator_EmployeeReport_getOutcomeInfo($outcome) {
    global $DB;
...
}//report_generator_EmployeeReport_getOutcomeInfo
 ...
 */
function report_generator_EmployeeReport_getOutcomeUsersInfo($courses_id,$job_roles,$company_id) {
    global $DB;
    ...
    try {
        ...
        $not_allowed = report_generator_getUsersNotAllowed();
        if ($not_allowed) {
        ...
        if ($rdo_users) {
            ...
            foreach ($rdo_users as $rdo) {
                ...
                if ($courses_id) {
                    $courses_completion     = report_generator_EmployeeReport_getCompletion($rdo->id,$courses_id);
...
}//report_generator_EmployeeReport_getOutcomeUsersInfo
 ...
 */
function report_generator_EmployeeReport_getCompletion($user_id,$course_lst) {
    global $DB;
...
}//report_generator_EmployeeReport_getCompletion
 ...
 */
function report_generator_EmployeeReport_getCertificate($user_id,$course_lst) {
    global $DB;
...
}//report_generator_EmployeeReport_getCertificate
 ...
 */
function report_generator_EmployeeReport_getTagTitleOutcome($outcome) {
    /* Variables    */
    $tag_header = '';
    ...
    return $tag_header;
}//report_generator_EmployeeReport_getTagTitleOutcome
 ...
 */
function report_generator_EmployeeReport_geContentReport($courses_lst,$expiration,$users_lst,$completed_time) {
    /* Variables    */
    $content = '';
    ...
    $content .= html_writer::start_tag('div',array('class' => 'employee_content'));
        $content .= html_writer::start_tag('table');
            /* HEADER   */
            $content .= report_generator_EmployeeReport_getHeaderContent($courses_lst);
            /* BODY     */
            $content .= report_generator_EmployeeReport_getBodyContent($expiration,$users_lst,$completed_time);
        $content .= html_writer::end_tag('table');
    $content .= html_writer::end_tag('div');

    return $content;
}//report_generator_EmployeeReport_geContentReport
     ...
     */
function report_generator_EmployeeReport_getHeaderContent($courses_lst) {
    /* Variables    */
    $header_content = '';
...
}//report_generator_EmployeeReport_getHeaderContent
 ...
 */
function report_generator_EmployeeReport_getBodyContent($expiration,$users_lst,$completed_time) {
    /* Variables    */
    $body_content = '';
            ...
            if ($course) {
                if ($course->completion) {
                    ...
                    if ($ts < time()) {
                        ...
                        $expiration_time = report_generator_get_completed_date_timestamp($completed_time,true);
