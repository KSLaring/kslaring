...
function xmldb_report_generator_upgrade($old_version) {
    ...
    if ($old_version < 2014110402) {
        ...
        if (!$db_man->table_exists('counties')) {
            ...
            CountyMunicipality_Upgrade::install_Counties();
        }//if_counties
        ...
        if (!$db_man->table_exists('municipality')) {
            ...
            CountyMunicipality_Upgrade::install_Østfold();
            CountyMunicipality_Upgrade::install_Akershus();
            CountyMunicipality_Upgrade::install_Oslo();
            CountyMunicipality_Upgrade::install_Hedmark();
            CountyMunicipality_Upgrade::install_Oppland();
            CountyMunicipality_Upgrade::install_Buskerud();
            CountyMunicipality_Upgrade::install_Vestfold();
            CountyMunicipality_Upgrade::install_Telemark();
            CountyMunicipality_Upgrade::install_Aust_Agder();
            CountyMunicipality_Upgrade::install_Vest_Agder();
            CountyMunicipality_Upgrade::install_Rogaland();
            CountyMunicipality_Upgrade::install_Hordaland();
            CountyMunicipality_Upgrade::install_Sogn_og_Fjordane();
            CountyMunicipality_Upgrade::install_Møre_og_Romsdal();
            CountyMunicipality_Upgrade::install_Sør_Trøndelag();
            CountyMunicipality_Upgrade::install_Nord_Trøndelag();
            CountyMunicipality_Upgrade::install_Nordland();
            CountyMunicipality_Upgrade::install_Troms();
            CountyMunicipality_Upgrade::install_Finnmark();
            CountyMunicipality_Upgrade::install_Svalbard();
        }//if_municipality
...
class CountyMunicipality_Upgrade {
