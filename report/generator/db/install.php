...
function xmldb_report_generator_install() {
    ...
    if (!$db_man->table_exists('counties')) {
        ...
        /* Install Counties */
        CountyMunicipality::install_Counties();
    }//if_counties
    /* Municipality */
    if (!$db_man->table_exists('municipality')) {
        $db_man->create_table($table_municipality);

        /* Install Municipalities   */
        CountyMunicipality::install_Østfold();
        CountyMunicipality::install_Akershus();
        CountyMunicipality::install_Oslo();
        CountyMunicipality::install_Hedmark();
        CountyMunicipality::install_Oppland();
        CountyMunicipality::install_Buskerud();
        CountyMunicipality::install_Vestfold();
        CountyMunicipality::install_Telemark();
        CountyMunicipality::install_Aust_Agder();
        CountyMunicipality::install_Vest_Agder();
        CountyMunicipality::install_Rogaland();
        CountyMunicipality::install_Hordaland();
        CountyMunicipality::install_Sogn_og_Fjordane();
        CountyMunicipality::install_Møre_og_Romsdal();
        CountyMunicipality::install_Sør_Trøndelag();
        CountyMunicipality::install_Nord_Trøndelag();
        CountyMunicipality::install_Nordland();
        CountyMunicipality::install_Troms();
        CountyMunicipality::install_Finnmark();
        CountyMunicipality::install_Svalbard();
    }//if_municipality
