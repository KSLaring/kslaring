...
/**
 * Report generator - Course report Level.
 *
 * Description
 *
 * @package     report
 * @subpackage  generator/course_report
...
$return_url     = new moodle_url('/report/generator/course_report/course_report.php');
...
$PAGE->set_url('/report/generator/course_report/course_report_level.php');
...
/* Show Form */
$url = new moodle_url('/report/generator/course_report/course_report_level.php',array('rpt'=>$report_level));
$form = new generator_course_report_level_form(null,array($report_level));
$out = '';
...
if ($form->is_cancelled()) {
    ...
    $out = report_generator_display_course_report($data_form);
}//if_else
