...
class generator_course_report_level_form extends moodleform {
    function definition() {
        /* General Settings */
        ...
        $m_form->addElement('html', '<div class="level-wrapper">');
            $m_form->addElement('select',
                                REPORT_GENERATOR_COURSE_LIST,
                                get_string('select_course_to_report', 'report_generator'),
                                report_generator_get_course_list(),
                                'onchange=saveCourse("course_list")');
        if (isset($_COOKIE['courseReport'])) {
            $m_form->setDefault(REPORT_GENERATOR_COURSE_LIST,$_COOKIE['courseReport']);
        }//if_cookie
    ...
    function validation($data, $files) {
        ...
        /* Check Course */
        if (!$data[REPORT_GENERATOR_COURSE_LIST]) {
            $errors[REPORT_GENERATOR_COURSE_LIST] = get_string('missing_course','report_generator');
        }//if_course_list
...
}//generator_course_report_level_form
