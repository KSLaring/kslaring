...
/**
 * Report Competence Manager - Java Script - Company Structure Selector - Outcome Report
 *
 * @package         report
...
M.core_user.init_organization = function (Y,name,jr_selector,out_selector,rptLevel) {
var level_structure = {
    ...
    /* Outcome Selector */
    outSelector : Y.one('#id_' + out_selector),
    ...
    send_query_job_roles : function(forceresearch) {
        ...
        var outcome     = this.outSelector.get('value');
        ...
        var iotrans = Y.io(M.cfg.wwwroot + '/report/manager/jobrole.php',
            {
                method: 'POST',
                data: 'levelZero=' + valueZero + '&levelOne=' + valueOne + '&levelTwo=' +  valueTwo + '&levelThree=' + valueThree + '&outcome=' + outcome + '&level=' + this.report_level + '&sesskey=' + M.cfg.sesskey,
                on: {
