...
class report_manager_managers_form extends moodleform {
    function definition() {
        ...
        $mForm->addElement('html','<div class="userselector" id="addselect_wrapper">');
            ...
            list($schoices,$tardis)   = Managers::FindManagers_Selector($removeSearch,$parents,$level);
            ...
            list($achoices,$tardis)   = Managers::FindPotentialManagers_Selector($addSearch,$parents,$level);
