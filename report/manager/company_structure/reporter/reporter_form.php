...
class report_manager_reporters_form extends moodleform {
    function definition() {
        ...
        $mForm->addElement('html','<div class="userselector" id="addselect_wrapper">');
            ...
            $schoices   = Reporters::FindReporters_Selector($removeSearch,$parentInfo->id,$level);
            ...
            $achoices   = Reporters::FindPotentialReporters_Selector($addSearch,$parentInfo->id,$level);
