...
class report_manager_reporters_form extends moodleform {
    function definition() {
        ...
        $mForm->addElement('html','<div class="userselector" id="addselect_wrapper">');
            ...
            list($schoices,$tardis)   = Reporters::FindReporters_Selector($removeSearch,$parents,$level);
            ...
            list($achoices,$tardis)   = Reporters::FindPotentialReporters_Selector($addSearch,$parents,$level);
