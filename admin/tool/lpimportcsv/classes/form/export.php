...
class export extends moodleform {
    ...
    public function definition() {
        ...
        if (empty($options)) {
            $frameworkid = $mform->addElement('static', 'frameworkid', '', get_string('noframeworks', 'tool_lpimportcsv'));
        } else {
            $frameworkid = $mform->addElement('select', 'frameworkid', get_string('competencyframework', 'tool_lp'), $options);
