 ...
 *
 * @module moodle-format_netcourse-netcourse_navigation
 */

/**
 * This namespace will contain all of the contents of the netcourse_navigation blocks
 * global netcourse_navigation and settings.
 * @namespace M
 * @class format_netcourse
 * @static
 */
M.format_netcourse = M.format_netcourse || {};
/**
 ...
 * @static
 */
M.format_netcourse.expandablebranchcount = 1;
/**
 ...
 * @static
 */
M.format_netcourse.courselimit = 20;
/**
 * Add new instance of netcourse_navigation tree to tree collection
 *
 * @method init_add_tree
 * @static
 * @param {Object} properties
 */
M.format_netcourse.init_add_tree = function (properties) {
 ...
 *
 * This event is delegated to branches in the netcourse_navigation tree.
 * The on() method to subscribe allows specifying the desired trigger actions as JSON.
 *
 * @namespace M.format_netcourse
 * @class ActionKey
 */
...
// Mappings for the different types of nodes coming from the netcourse_navigation.
// Copied from lib/netcourse_navigationlib.php netcourse_navigation_node constants.
var NODETYPE = {
...
TREE.prototype = {
    ...
    initializer: function (config) {
        Y.log('Initialising netcourse_navigation block tree', 'note', 'moodle-format_netcourse');
        ...
        if (M.format_netcourse.expandablebranchcount > 0) {
...
Y.extend(TREE, Y.Base, TREE.prototype, {
    NAME: 'netcourse_navigation-tree',
    ATTRS: {
        /**
...
//            value : false
        ...
        /**
         * The netcourse_navigation tree block instance.
         */
        instance: {
            value: false,
            setter: function (val) {
...
BRANCH.prototype = {
     ...
     * it into the netcourse_navigation tree at the correct point.
     *
     * @method draw
     * @chainable
     * @param {Node} element
    ...
    ajaxLoad: function (e) {
        ...
        Y.log('Loading netcourse_navigation branch via AJAX: ' + this.get('key'), 'note', 'moodle-format_netcourse');
        ...
        // For siteadmin netcourse_navigation get tree from getsiteadminbranch.php.
    ...
    ajaxProcessResponse: function (tid, outcome) {
        ...
        try {
            ...
            if (object.children && object.children.length > 0) {
                ...
                Y.log('AJAX loading complete.', 'note', 'moodle-format_netcourse');
                // If this block can dock tell the dock to resize if required and check
                // the width on the dock panel in case it is presently in use.
            ...
            Y.log('AJAX loading complete but there were no children.', 'note', 'moodle-format_netcourse');
        } catch (error) {
    ...
    addChild: function (branchobj) {
        ...
        if (branch.draw(this.getChildrenUL())) {
            ...
            if ((branch.get('type') === NODETYPE.CATEGORY || branch.get('type') === NODETYPE.MYCATEGORY)
                && count >= M.format_netcourse.courselimit) {
    ...
    addViewAllCoursesChild: function (branch) {
        ...
        branch.addChild({
            ...
            link: url,
            haschildren: false,
            icon: {'pix': "i/netcourse_navigationitem", 'component': 'moodle'}
        });
    }
};
Y.extend(BRANCH, Y.Base, BRANCH.prototype, {
    NAME: 'netcourse_navigation-branch',
    ATTRS: {
        /**
        ...
        id: {
            ...
            getter: function (val) {
                if (val === '') {
                    val = 'expandable_branch_' + M.format_netcourse.expandablebranchcount;
                    M.format_netcourse.expandablebranchcount++;
                }
                return val;
            }
