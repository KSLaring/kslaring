...
/**
 * Strings for component 'format_netcourse', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['pluginname'] = 'Nettkursformat';

$string['section0name'] = 'Generelt';
$string['page-course-view-netcourse'] = 'En kursforside i nettkursformat';
$string['page-course-view-netcourse-x'] = 'En kursside i nettkursformat';
