...
/**
 * Whitepaper Format  - Language Settings (Norwegian)
 *
 * @package         course
...
$string['activitytype_help'] = 'Velg en aktivitetstype eller ressurs som skal brukes i dette kurset.';
$string['defactivitytype'] = 'Standard aktivitetstype';
$string['defactivitytypedesc'] = 'Velg aktivitetstypen som skal være standard når nye kurs av dette formatet opprettes';
