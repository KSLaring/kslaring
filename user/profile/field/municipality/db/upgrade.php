...
function xmldb_profilefield_municipality_upgrade($old_version) {
    ...
    if ($old_version < 2014112000) {
        ...
        if ($info_old_profile) {
            ...
            UpdateProfile_NewVersion_Upgrade($info_old_profile);
        }//if_info_old_profile
    }
 ...
 */
function GetInfo_OldProfile_Upgrade() {
    /* Variables    */
    global $DB;
    ...
    try {
        ...
        if ($rdo) {
            ...
            /* Get Users Connected  */
            $info->users                = GetUsersConnected_Upgrade($rdo->id);
 ...
 */
function GetUsersConnected_Upgrade($field_id) {
    /* Variables    */
    global $DB;
    $users_lst = array();
 ...
 * Update the Municipality profile field to the new version
 */
function UpdateProfile_NewVersion_Upgrade($info_old_profile) {
    /* Variables    */
    global $DB;
