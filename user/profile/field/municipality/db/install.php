...
function xmldb_profilefield_municipality_install() {
    ...
    $info_old_profile = GetInfo_OldProfile();
    if ($info_old_profile) {
        /* Update the Municipality profile field to the new version  */
        UpdateProfile_NewVersion($info_old_profile);
    }//if_info_old_profile
...
function GetInfo_OldProfile() {
    ...
    try {
        ...
        if ($rdo) {
            ...
            /* Get Users Connected  */
            $info->users                = GetUsersConnected($rdo->id);
 ...
 */
function GetUsersConnected($field_id) {
    /* Variables    */
    global $DB;
    $users_lst = array();
 ...
 * Update the Municipality profile field to the new version
 */
function UpdateProfile_NewVersion($info_old_profile) {
    /* Variables    */
    global $DB;
