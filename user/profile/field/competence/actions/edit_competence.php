...
$url            = new moodle_url('/user/profile/field/competence/actions/edit_competence.php',array('id' =>$user_id,'ge' => $generics));
...
/* Form */
$form = new competence_edit_competence_form(null,array($user_id,$generics));
