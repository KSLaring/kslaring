 ...
 */
function theme_stavanger_page_init(moodle_page $page) {
 ...
 */
function theme_stavanger_process_css($css, $theme) {
 ...
 */
function theme_stavanger_set_fontwww($css) {
 ...
 */
function theme_stavanger_set_logo($css, $logo) {
 ...
 * @return bool
 */
function theme_stavanger_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload,
    array $options = array()) {
    static $theme;

    if (empty($theme)) {
        $theme = theme_config::load('stavanger');
    }
 ...
 */
function theme_stavanger_set_customcss($css, $customcss) {
 ...
 */
function theme_stavanger_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
    $strhome = get_string('home');
    $strfootertext = get_string('footertext', 'theme_stavanger');
    $strfooterhelpurl = get_string('footerhelpurl', 'theme_stavanger');
    $strhelp = get_string('help');
    $footerbrukerhelp = get_string('footerbrukerhelp', 'theme_stavanger');
    $return->heroheadline = '';
 ...
 * @return bool
 */
function theme_stavanger_show_hidden_blocks() {
