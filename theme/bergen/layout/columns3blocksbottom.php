...
$html = theme_bergen_get_html_for_settings($OUTPUT, $PAGE);
$show_hidden_blocks = theme_bergen_show_hidden_blocks($PAGE);
$str_visibleadminonly = get_string('visibleadminonly', 'theme_bergen');
