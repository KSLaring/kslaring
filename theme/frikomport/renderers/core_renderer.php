        ...
        if ($addusermenu) {
            if (isloggedin()) {
                ...
                if ($my_page == $PAGE->url) {
                    ...
                    $usermenu->add('<i class="fa fa-user"></i>' . get_string('resethome', 'theme_frikomport'), $urlMyPage,get_string('resethome', 'theme_frikomport'));
                }else {
                    ...
                    if ($found) {
                        ...
                        $usermenu->add('<i class="fa fa-user"></i>' . get_string('sethome', 'theme_frikomport'), $urlMyPage,get_string('sethome', 'theme_frikomport'));
                    }
                }
