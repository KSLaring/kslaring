...
$html = theme_frikomport_get_html_for_settings($OUTPUT, $PAGE);
$show_hidden_blocks = theme_frikomport_show_hidden_blocks($PAGE);
$str_visibleadminonly = get_string('visibleadminonly', 'theme_frikomport');
