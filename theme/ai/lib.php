 ...
 */
function theme_ai_page_init(moodle_page $page) {
 ...
 */
function theme_ai_process_css($css, $theme) {
 ...
 */
function theme_ai_set_fontwww($css) {
 ...
 */
function theme_ai_set_logo($css, $logo) {
 ...
 * @return bool
 */
function theme_ai_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload,
    array $options = array()) {
    static $theme;

    if (empty($theme)) {
        $theme = theme_config::load('ai');
    }
 ...
 */
function theme_ai_set_customcss($css, $customcss) {
 ...
 */
function theme_ai_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
    $strhome = get_string('home');
    $strfootertext = get_string('footertext', 'theme_ai');
    $strfooterhelpurl = get_string('footerhelpurl', 'theme_ai');
    $strhelp = get_string('help');
    $footerbrukerhelp = get_string('footerbrukerhelp', 'theme_ai');
    $return->headertxtlaering = get_string('laering', 'theme_ai');
    $return->headertxtsystem = get_string('system', 'theme_ai');
    $return->heroheadline = '';
 ...
 * @return bool
 */
function theme_ai_show_hidden_blocks() {
