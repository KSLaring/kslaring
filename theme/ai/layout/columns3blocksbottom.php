...
/**
 * Moodle's ai theme, an example of how to make a Bootstrap theme
 *
...
$html = theme_ai_get_html_for_settings($OUTPUT, $PAGE);
$show_hidden_blocks = theme_ai_show_hidden_blocks($PAGE);
$str_visibleadminonly = get_string('visibleadminonly', 'theme_ai');
...
<div id="page" class="container-fluid">
    ...
    <div id="bottom-area" class="row-fluid">
