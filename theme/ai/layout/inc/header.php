    ...
    <div class="container-fluid">
        <div class="logo-area">
            <a class="home-link" href="<?php echo $CFG->wwwroot; ?>">
                <img class="logo" alt="Arbeid og inkludering logo" src="<?php echo $OUTPUT->pix_url('ai_logo', 'theme'); ?>"/>
            </a>
        </div>

        <div class="header-right">
            <?php if ($municipality) {
                echo '<div class="muni-logo"> <img class="logo" alt="' . $municipality->name . '" src="' .
                    $municipality->logo . '"/></div>';
            } ?>
        </div>
    </div>
</div>
