 ...
 */
function theme_ailaring_page_init(moodle_page $page) {
 ...
 */
function theme_ailaring_process_css($css, $theme) {
 ...
 */
function theme_ailaring_set_fontwww($css) {
 ...
 */
function theme_ailaring_set_logo($css, $logo) {
 ...
 * @return bool
 */
function theme_ailaring_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload,
    array $options = array()) {
    static $theme;

    if (empty($theme)) {
        $theme = theme_config::load('ailaring');
    }
 ...
 */
function theme_ailaring_set_customcss($css, $customcss) {
 ...
 */
function theme_ailaring_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
    $strhome = get_string('home');
    $strfootertext = get_string('footertext', 'theme_ailaring');
    $strfooterhelpurl = get_string('footerhelpurl', 'theme_ailaring');
    $strhelp = get_string('help');
    $footerbrukerhelp = get_string('footerbrukerhelp', 'theme_ailaring');
    $return->heroheadline = '';
 ...
 * @return bool
 */
function theme_ailaring_show_hidden_blocks() {
