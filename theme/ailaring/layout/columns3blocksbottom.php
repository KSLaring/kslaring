...
$html = theme_ailaring_get_html_for_settings($OUTPUT, $PAGE);
$show_hidden_blocks = theme_ailaring_show_hidden_blocks($PAGE);
$str_visibleadminonly = get_string('visibleadminonly', 'theme_ailaring');
