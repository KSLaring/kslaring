...
/**
 * Strings for component 'theme_ailaring', language 'en'
 *
...
$string['choosereadme'] = 'Hei, jeg er aiLaring-designet';

$string['configtitle'] = 'aiLaring';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Vennligst last opp logoen din her hvis du vil ha en annen i toppteksten.<br>
...
$string['mydashboard'] = 'Mitt dashbord';

/* Edit mode toggle */
$string['editoff'] = 'Av';
$string['editon'] = 'På';
$string['edit_label'] = 'Redigeringsmodus:';
...
/* Capabilities */
$string['ailaring:viewhiddenblocks'] = 'View hidden blocks';
$string['ailaring:frontpageviewhiddenblocks'] = 'View hidden frontpage blocks';
...
/* Header text */
$string['headertitle'] = 'AI Læring <span class="smaller">Kursadministrasjonssystem for aiLaring</span>';

/* Footer text */
$string['footertext'] = '<strong>Arbeid & Inkludering i NHO Service - Postboks 5473, Majorstuen - 0305 Oslo</strong><br>
Tlf: 23 08 86 50 - Fax: 23 08 86 59<br>
<br>
© 2001-2017 Arbeid & Inkludering i NHO Service';
