...
// in version.php and lang/en/theme_starter.php as well.
//////////////////////////////////
//
$THEME->doctype = 'html5';
...
$THEME->csspostprocess = 'theme_starter_process_css';
...
$THEME->layouts = array(
    ...
    'mydashboard' => array(
        'file' => 'columns3.php',
        'regions' => array('side-pre', 'side-post', 'content', 'top', 'bottom', 'content-top'),
        'defaultregion' => 'side-pre',
        'options' => array('langmenu'=>true),
    )
);