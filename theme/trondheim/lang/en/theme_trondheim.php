...
$string['choosereadme'] = 'Hey, I\'m trondheim';
...
/* Header text */
$string['laering'] = 'TK Læring';
$string['system'] = 'Kursadministrasjonssystem for Trondheim kommune';

/* Footer text */
$string['footertext'] = 'Trondheim kommune benytter KS Læring for kursadministrasjon og e-læring.<br/>
Systemeier: Personal og organisasjon ved HR-utvikling.';
