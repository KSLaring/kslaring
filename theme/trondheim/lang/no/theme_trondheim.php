...
/**
 * Strings for component 'theme_trondheim', language 'en'
 *
...
$string['choosereadme'] = 'Hei, jeg er Trondheim-designet';

$string['configtitle'] = 'Trondheim';
...
/* Capabilities */
$string['trondheim:viewhiddenblocks'] = 'View hidden blocks';
$string['trondheim:frontpageviewhiddenblocks'] = 'View hidden frontpage blocks';
...
/* Footer text */
$string['footertext']    = 'Trondheim kommune benytter KS Læring for kursadministrasjon og nettlæring.<br>
