...
$event = \mod_completionreset\event\course_module_instance_list_viewed::create(array('context' => context_course::instance($course->id)));
...
$PAGE->set_url('/mod/completionreset/index.php', array('id' => $course->id));
