...
class mod_registerattendance_view_table extends mod_registerattendance_widget implements renderable {
    ...
    public function render() {
        ...
        if (!empty($this->filterdata['searchname'])) {
            ...
            $table->sess->i_first = '';
            $table->sess->i_last = '';
            list($where, $whereparams) = $this->get_sql_namesearch_where($this->filterdata['searchname']);
        } else {
    ...
    protected function get_sql_namesearch_where($searchname) {
        ...
        $likefirstname = $DB->sql_like('u.firstname', ':firstname', false);
        $likelastname = $DB->sql_like('u.lastname', ':lastname', false);
