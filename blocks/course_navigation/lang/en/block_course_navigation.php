...
/**
 * This file contains language strings used in the global course_navigation block
 *
 * @since      2.0
 * @package    blocks
...
$string['expansionlimit'] = 'Generate course_navigation for the following';
$string['linkcategoriesdesc'] = 'Display categories as links';
$string['course_navigation:addinstance'] = 'Add a new course_navigation block';
$string['course_navigation:myaddinstance'] = 'Add a new course_navigation block to My home';
