...
/**
 * Form for editing global course_navigation instances.
 *
 * @since      2.0
...
class block_course_navigation_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $options = array(
                block_course_navigation::TRIM_RIGHT => get_string('trimmoderight', $this->block->blockname),
                block_course_navigation::TRIM_LEFT => get_string('trimmodeleft', $this->block->blockname),
                block_course_navigation::TRIM_CENTER => get_string('trimmodecenter', $this->block->blockname)
        );
