YUI.add('moodle-atto_efimage-button', function (Y, NAME) {
...
/*
 * @package    atto_efimage
 * @copyright  2013 Damyon Wiese  <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-atto_efimage_alignment-button
 */

/**
 * Atto image selection tool.
 *
 * @namespace M.atto_efimage
 * @class Button
...
var CSS = {
        ...
        INPUTALIGNMENT: 'atto_efimage_alignment',
        INPUTALT: 'atto_efimage_altentry',
        INPUTHEIGHT: 'atto_efimage_heightentry',
        INPUTSUBMIT: 'atto_efimage_urlentrysubmit',
        INPUTURL: 'atto_efimage_urlentry',
        INPUTSIZE: 'atto_efimage_size',
        INPUTWIDTH: 'atto_efimage_widthentry',
        IMAGEALTWARNING: 'atto_efimage_altwarning',
        IMAGEBROWSER: 'openimagebrowser',
        IMAGEPRESENTATION: 'atto_efimage_presentation',
        INPUTCONSTRAIN: 'atto_efimage_constrain',
        INPUTCUSTOMSTYLE: 'atto_efimage_customstyle',
        IMAGEPREVIEW: 'atto_efimage_preview',
        IMAGEPREVIEWBOX: 'atto_efimage_preview_box'
    },
    SELECTORS = {
...
Y.namespace('M.atto_efimage').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    /**
