...
/**
 * Strings for component 'atto_kitable', language 'en'.
 *
...
$string['createtable'] = 'Create a KommIT table';
...
$string['pluginname'] = 'KommIT Table';
$string['rows'] = 'Rows';
$string['updatetable'] = 'Update table';
$string['tabletype'] = 'Table type';
$string['table1'] = 'Type 1';
$string['table2nolines'] = 'Type 2 without cell borders';
$string['table2lines'] = 'Type 2 with cell borders';
$string['table3'] = 'Type 3';
